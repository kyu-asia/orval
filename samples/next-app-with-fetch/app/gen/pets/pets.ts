/**
 * Generated by @kyu-asia/orval v8.5.3 🍺
...
export const listPets =
  (options?: RequestInit) => async (params?: ListPetsParams) => {
...
export const createPets =
  (options?: RequestInit) =>
  async (createPetsBodyItem: CreatePetsBodyItem[]) => {
...
export const updatePets =
  (options?: RequestInit) => async (pet: NonReadonly<Pet>) => {
...
export const showPetById = (options?: RequestInit) => async (petId: string) => {
